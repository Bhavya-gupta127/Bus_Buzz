...
<div id="bg-bus">
<lottie-player src="https://assets10.lottiefiles.com/packages/lf20_fgvmiyev.json"  background="transparent" position="absolute" z-index="-1" speed="1"  style="width: 100vw; height: 100vh;"  loop  autoplay></lottie-player>
    ...
    <div class="modal fadeIn" tabindex="-1" id="uni_modal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <!-- <button type="button" class="btn btn-secondary bsdk" data-dismiss="modal">Request New Bus</button> -->
          <?php
...
?>
          <button type="button" class="btn btn-secondary bsdk" onclick=handleclick()>
              Request New Bus 
          </button>

            <button type="button" class="btn btn-success submit yoyo" onclick="$('#uni_modal form').submit()">
